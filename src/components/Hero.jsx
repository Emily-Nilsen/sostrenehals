...
export function Hero() {
  ...
  return (
    <div className="relative max-h-screen min-h-[50vh] pt-10 pb-20 sm:min-h-[768px] sm:py-24 md:max-h-[768px]">
      <div className="absolute inset-x-0 -top-48 -bottom-14 overflow-hidden bg-gradient-to-br from-couture-darkGold to-nutmeg">
        <Image
