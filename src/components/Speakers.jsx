    ...
    >
      ...
      <Container>
        ...
        <div className="max-w-2xl mx-auto lg:mx-0">
          <h2
            id="speakers-title"
            className="text-4xl font-medium tracking-tighter text-nutmeg font-display sm:text-5xl"
          >
            Speakers
          </h2>
          <p className="mt-4 text-2xl tracking-tight text-couture-darkGold font-display">
        ...
        >
          <div className="relative flex pb-4 -mx-4 overflow-x-auto sm:mx-0 sm:block sm:overflow-visible sm:pb-0">
            <div className="absolute bottom-0 top-2 left-0.5 hidden w-px bg-couture-lightBlue lg:block" />
                  ...
                  <div key={day.dateTime} className="relative lg:pl-8">
                    <DiamondIcon
                      className={clsx(
                        ...
                        dayIndex === selectedIndex
                          ? 'fill-couture-darkTan stroke-couture-lightTan'
                    ...
                    <div className="relative">
                      ...
                      <time
                        ...
                        className="mt-1.5 block text-2xl font-semibold tracking-tight text-couture-mediumBlue"
                      >
                        {day.date}
                      </time>
                    </div>
